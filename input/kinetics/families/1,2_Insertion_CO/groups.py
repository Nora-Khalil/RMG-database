...
entry(
    ...
    group = 
"""
1 *2 [Cd,CO,Sid,Cs,Cb,Sis,O,Ct,S,N] u0 r0 {2,S}
2 *3 Br1s                           u0 r0 {1,S}
3 *1 C                              u0 p1 c-1 r0 {4,T}
4 *4 O                              u0 p1 c+1 r0 {3,T}
""",
...
6    [I,Br,Cl,O,Si,P,S,N,F] ux {5,[S,D,T,B,Q]}
""",
    kinetics = None,
)
...
"""
1 *2 O  u0 {2,S}
2 *3 Cs u0 {1,S} {5,[S,D,T,B,Q]} {6,[S,D,T,B,Q]}
3 *1 C  u0 p1 c-1 {4,T}
4 *4 O  u0 p1 c+1 {3,T}
5    C  ux {2,[S,D,T,B,Q]}
6    F  ux {2,[S,D,T,B,Q]}
...
3 *1 C                      u0 p1 c-1 r0 {4,T}
4 *4 O                      u0 p1 c+1 r0 {3,T}
5    [I,Br,Cl,O,Si,P,S,N,F] u0 r0 {2,S}
""",
    kinetics = None,
)
