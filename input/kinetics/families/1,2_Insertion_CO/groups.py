...
entry(
    ...
    group = 
"""
1 *2 [Ct,Sis,S,N,CO,Cd,Sid,Cs,Cb,O]                u0 {2,S}
2 *3 [H,F1s,Cl1s,Br1s,I1s,Cs,Cd,Cb,Ct,Sis,Sid,N,S] u0 {1,S}
3 *1 C                                             u0 p1 c-1 {4,T}
4 *4 O                                             u0 p1 c+1 {3,T}
""",
...
4 *4 O                      u0 p1 c+1 r0 {3,T}
5    O                      u0 r0 {1,S} {6,S}
6    [Si,S,N,P,F,I,Br,Cl,O] ux r0 {5,S}
""",
    kinetics = None,
)
...
3 *1 C                      u0 p1 c-1 {4,T}
4 *4 O                      u0 p1 c+1 {3,T}
5    [Si,S,N,P,F,I,C,Br,Cl] ux {1,[S,D,T,B,Q]}
""",
    kinetics = None,
)
